"""Agent list, detail, config, and delete pages.

Pool assignment is the only infra-adjacent control the admin UI still exposes.
All other infra concerns (scaling, identity, policy) moved to the infra-team
GitOps catalog at `k8s/platform/pools/`.
"""
...
async def agent_list(
    ...
    # Last activity = most recent session message per agent.
